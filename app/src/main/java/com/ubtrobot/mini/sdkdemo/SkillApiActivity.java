...
import com.ubtrobot.mini.sdkdemo.skills.MyClassificationSkillDemo;
...
import com.ubtrobot.mini.sdkdemo.tools.PermisionUtils;
...
public class SkillApiActivity extends AppCompatActivity {
    ...
    public void imgClassification(View view) {
        PermisionUtils.verifyStoragePermissions(this);
        //MyClassificationSkillDemo.doSkill();
        SkillHelper.startSkillByPath("/my_classification/startSkill", null);
